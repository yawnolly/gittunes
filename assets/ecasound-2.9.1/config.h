...
/* ecasound specific versioning of JACK interface features */
#define ECA_JACK_FEATSET 0

/* version of JACK transport API to use */
#define ECA_JACK_TRANSPORT_API 0
...
/* Use liblilv for LV2 support */
/* #undef ECA_USE_LIBLILV */
